--[[ 
    FILE: fishing_mhdxr_v3.1.lua (MOD Auto Favorite v4.0)
...
local GUI_NAMES = {
    Main = "MHdXR_Fishing_UI",
    Mobile = "MHdXR_Mobile_Button",
    Coords = "MHdXR_Coords_HUD"
}
...
for _, v in pairs(CoreGui:GetDescendants()) do
    if v:IsA("TextLabel") and v.Text == "MHdXR" then
...
local Window = WindUI:CreateWindow({ Title = "MHdXR", Icon = "chess-king", Author = "by UQi", Transparent = true })
